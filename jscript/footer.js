document.addEventListener('DOMContentLoaded', () => {
    function createFooter() {
        ...
        socialMedia.forEach(media => {
            ...
            // Append the link to social links container
        ...
        button.onclick = openForm; // Assign click event to openForm function
    ...
    createFooter(); // Call the function to create the footer
});
